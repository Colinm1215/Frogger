...
class Sprite {
    ...
    static final int NORTH = 90, SOUTH = 270, WEST = 180, EAST = 0, NE = 45, NW = 135, SW = 225, SE = 315;
    ...
    Sprite(int x, int y, int dir, int type) {
        this.loc = new Point(x, y);
        this.dir = dir;
        setPic("blank.png", dir);  //Assumes pic is oriented NORTH by default
     ...
     */
    void setPic(String fileName, int orientation) {
        try {
    ...
    void draw(Graphics2D g2) {
        ...
        double halfWidth = pic.getWidth() / 2.0;
        double halfHeight = pic.getHeight() / 2.0;
...
//        g2.draw(getBoundingRectangle());
     ...
     *
     * @param loc the new location as Point (x, y)
     */
    ...
    private void setPic(BufferedImage pic) {
        this.pic = pic;
    }
